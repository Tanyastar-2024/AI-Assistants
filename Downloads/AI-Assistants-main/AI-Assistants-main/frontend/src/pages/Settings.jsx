...
const ADMIN_EMAIL = 'tanyabrownt674@gmail.com';
...
export default function Settings() {
  ...
  const [userStats, setUserStats] = useState({ xp: 0, streak: 0, lectureCount: 0 });
      ...
      <aside className="sidebar">
        ...
        <div className="sidebar-user" style={{ marginTop: '0' }}>
          ...
          <div className="user-info">
            ...
            <div className="user-level">⚡ Level {Math.floor(userStats.xp / 500) + 1} Scholar</div>
          </div>
        </div>
      </aside>
      ...
      <main className="main">
        <div className="page active">
          <div className="page-header">
            ...
            <h1>Settings ⚙️</h1>
            <p>Your account dashboard and preferences</p>
          </div>
          ...
          <div className="card" style={{ maxWidth: '640px', marginBottom: '24px', padding: '28px' }}>
            <div style={{ display: 'flex', alignItems: 'center', gap: '16px', marginBottom: '24px' }}>
              ...
              <div>
                <div style={{ fontWeight: 700, fontSize: '22px' }}>{userName}</div>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: '16px' }}>
              <div style={{
                background: 'rgba(180, 120, 255, 0.1)', borderRadius: '12px',
                padding: '16px', textAlign: 'center'
              }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: 'var(--purple)' }}>
                  {userStats.xp}
                </div>
              ...
              <div style={{
                background: 'rgba(255, 110, 180, 0.1)', borderRadius: '12px',
                padding: '16px', textAlign: 'center'
              }}>
                <div style={{ fontSize: '28px', fontWeight: 700, color: 'var(--pink)' }}>
                  🔥 {userStats.streak}
                </div>
                <div style={{ fontSize: '12px', color: 'var(--text-muted)', fontWeight: 600, marginTop: '4px' }}>
                  Day Streak
